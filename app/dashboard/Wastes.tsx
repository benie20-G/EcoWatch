...
function Wastes() {
  ...
  <section className='flex bg-white m-2 p-4 gap-3 w-auto rounded-2xl justify-between'>
   ...
   {WASTES.map((waste,index)=>(
    <div  className={`bg-${waste.variant}-50 w-64 px-4 pb-4 flex flex-col text-white BackgroundFrame${index}  gap-4 rounded-2xl`}>
      <div className='bg-red-50 bg-gray-50'></div> {/* this is for enabling retrieval of those colors from waste.variant it doesn't show anything else*/}
